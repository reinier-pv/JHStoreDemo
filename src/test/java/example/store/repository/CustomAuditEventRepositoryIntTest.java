package example.store.repository;

import example.store.StoreDemoApp;
import example.store.config.Constants;
import example.store.config.audit.AuditEventConverter;
import example.store.domain.PersistentAuditEvent;
...
import static example.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
