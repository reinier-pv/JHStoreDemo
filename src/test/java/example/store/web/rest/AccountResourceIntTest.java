package example.store.web.rest;

import example.store.config.Constants;
import example.store.StoreDemoApp;
import example.store.domain.Authority;
import example.store.domain.User;
import example.store.repository.AuthorityRepository;
import example.store.repository.UserRepository;
import example.store.security.AuthoritiesConstants;
import example.store.service.MailService;
import example.store.service.dto.UserDTO;
import example.store.web.rest.errors.ExceptionTranslator;
import example.store.web.rest.vm.KeyAndPasswordVM;
import example.store.web.rest.vm.ManagedUserVM;
import example.store.service.UserService;
...
@SpringBootTest(classes = StoreDemoApp.class)
